...
export const teamMembers: TeamMember[] = [
    ...
    },
    {
        ...
        about: "As the **Lead Developer alongside [Joy](/team/adu-joy-atakora)**, Obrempong has been instrumental in the GESA Software Engineering Team. With a strong background in software engineering and technology, and currently in his third year pursuing Geomatic Engineering, he aims to merge technology with the construction industry, particularly surveying, by integrating geospatial tools, data analytics, and modern digital solutions to improve accuracy, efficiency, and decision-making in construction projects, working closely with his sister, **Architect Abigail Nana Akua Osei-Wusu** and  his mentor **Surv.Hubert Owusu Boateng**. In his role as Lead Developer, he brings this interdisciplinary perspective to the GESA Web Application project, ensuring that the team’s solutions are not only technically sound but also practical, innovative, and aligned with the needs of the students they serve."
    },
    {
        ...
        about: "As the **Lead Developer together with [Obrempong](/team/obrempong-kwabena-osei-wusu)**, Joy has been instrumental in the GESA Software Engineering Team. With a robust background in software engineering and technology, and currently in 3rd year pursuing Telecom Engineering, he brings a unique perspective to the project, ensuring that our solutions are not just technically sound but also relevant to the students we serve."
    },
    {
