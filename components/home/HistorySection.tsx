                        ...
                        >
                            {historyData.funFacts.map((fact, i) => (
                                <motion.div
                                    ...
                                    whileHover={{ y: -5 }}
                                    className="p-8 rounded-3xl bg-gray-50 hover:bg-white hover:shadow-xl transition-[background-color,border-color,box-shadow] duration-500 border border-transparent hover:border-primary/20 group"
                                >
