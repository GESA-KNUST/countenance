...
const EventCard: React.FC<EventCardProps> = ({
  ...
  return (
    <div className="relative min-h-[480px] w-full sm:w-[340px] lg:w-[300px] xl:w-[334px] shadow-lg p-5 flex flex-col justify-between rounded transition-transform duration-300 hover:scale-[1.02]">
      ...
      {showMap && (
        <div className="absolute inset-0 bg-white z-20 p-4 flex flex-col shadow-lg rounded">
          <button
            onClick={() => setShowMap(false)}
            className="self-end p-1 text-gray-700 hover:text-black"
